#!/usr/bin/env python
"""Stage 7 (gao25 · l6) — Organize SCENIC+ eRegulons into a clean regulon -> gene table (mouse L6).

Fork of scripts/19.gao25.organize_regulons.py for the L6 layer (plan/06); logic unchanged, repointed
at the l6 work dir. From the Stage 5 direct/extended eRegulon tables, build one long table where each
...
Run: conda run --no-capture-output -n epics python -u scripts/19.gao25.l6.organize_regulons.py
"""
import argparse
import os
import sys
...
WORK = f"{PROJ}/data/gao25/l6/work"
