#!/usr/bin/env bash
# Stage 5 (gao25 · l4) — SCENIC+ GRN inference → eRegulons + per-cell activity (mouse L4/5).
# Fork of scripts/17.gao25.run_grn.sh for the L4 layer (plan/06). Params are species-agnostic and
# unchanged; only the work/DB paths point at the l4 namespace.
...
# Run: bash scripts/17.gao25.l4.run_grn.sh
set -euo pipefail
...
echo "[$(date)] Stage 5 gao25·l4 complete:"
