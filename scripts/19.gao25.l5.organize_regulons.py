#!/usr/bin/env python
"""Stage 7 (gao25 · l5) — Organize SCENIC+ eRegulons into a clean regulon -> gene table (mouse L5).

Fork of scripts/19.gao25.organize_regulons.py for the L5 layer (plan/06); logic unchanged, repointed
at the l5 work dir. From the Stage 5 direct/extended eRegulon tables, build one long table where each
...
Run: conda run --no-capture-output -n epics python -u scripts/19.gao25.l5.organize_regulons.py
"""
import argparse
import os
import sys
...
WORK = f"{PROJ}/data/gao25/l5/work"
